...
var app = (function () {
    ...
    const skills = [ // List of contact information
        ...
        },
        {
            ...
            text: "HTML, CSS/SCSS, JavaScript/TypeScript, Leaflet, Svelte, Node",
            rating: "75"
        },
        {
            name: "Writing",
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link4, file, 25, 2, 824);
    			...
    			add_location(link5, file, 31, 2, 930);
    			attr_dev(link6, "rel", "manifest");
    			attr_dev(link6, "href", "favicons//site.webmanifest");
    			add_location(link6, file, 37, 2, 1036);
    			attr_dev(link7, "rel", "mask-icon");
    			attr_dev(link7, "href", "favicons//safari-pinned-tab.svg");
    			attr_dev(link7, "color", "#5bbad5");
    			add_location(link7, file, 38, 2, 1096);
    			attr_dev(meta0, "name", "msapplication-TileColor");
    			attr_dev(meta0, "content", "#da532c");
    			add_location(meta0, file, 43, 2, 1192);
    			attr_dev(meta1, "name", "theme-color");
    			attr_dev(meta1, "content", "#ffffff");
    			add_location(meta1, file, 44, 2, 1252);
    			attr_dev(meta2, "name", "description");
    			attr_dev(meta2, "content", "Josh Pooley's resume as a data scientist, developer and prototyper.");
    			add_location(meta2, file, 45, 2, 1300);
    			attr_dev(meta3, "name", "keywords");
    			attr_dev(meta3, "content", "resume, data scientist, developer, prototyper.");
    			add_location(meta3, file, 49, 2, 1418);
